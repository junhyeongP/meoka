...
function createNewElement() {
	...
	txtNewInputBox.innerHTML = " 조리 방법 <input type='text' name='RECIPEDETAIL'> 사 진 <input type='text' name='PHOTO'><input type='button'id='detailRemove' value='삭제' onclick='removeDetail(this)'>";
