...
public class RecipeDAOImpl implements RecipeDAO {
	...
	public void write(RecipeVO recipe) throws Exception {
		sql.insert(namespace + ".write", recipe);
	}
	...
	public void writeRecipeDetail(Integer RECIPEDETAILNO,String RECIPEDETAIL,String PHOTO) throws Exception{
		RecipeVO vo = new RecipeVO();
		/*
		 * ArrayList recipe= new ArrayList(); recipe.add(RECIPEDETAILNO, RECIPEDETAIL);
		 * recipe.add(RECIPEDETAILNO,PHOTO); recipe.add(RECIPEDETAILNO, RECIPEDETAILNO);
		 */
		sql.insert(namespace + ".writeRecipeDetail",vo);
	}
	
	public void writeUtensil(int j,String utensilName) throws Exception {
		sql.insert(namespace + ".writeRecipeDetail", utensilName);
	}
